...
class ZigbeeNode():
    ...
    def __init__(self, node_id, target_func = None, target_args = None):  # type: ignore
        ...
        self.transceiver = ZigbeeTransceiver(broker_address='192.168.0.184', broker_port=1883)  # address and port subject to change
...
class ZigbeeTransceiver():
    ...
    def __init__(self, broker_address='192.168.0.184', broker_port=1883, username=None, password=None):
