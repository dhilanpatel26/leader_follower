...
class Node:
    def __init__(self, node_id, target_func = None, target_args = None):
        ...
        self.thisDevice = hp.ThisDevice(self.__hash__() % 10000, self.transceiver)
        ...
        elif target_func == "tie":
            target_func = self.thisDevice.test_tiebreaker
