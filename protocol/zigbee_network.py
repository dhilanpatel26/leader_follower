...
class ZigbeeNode():
    ...
    def __init__(self, node_id, active: multiprocessing.Value = None, ip= '172.20.10.2', target_func = None, target_args = None):  # type: ignore
...
class ZigbeeUINode(ZigbeeNode):
    def __init__(self, node_id=-1, active: multiprocessing.Value = None, ip= '172.20.10.2', target_func = None, target_args = None):
        self.node_id = node_id
        self.active = active
...
class ZigbeeTransceiver():
    ...
    def __init__(self, broker_address='172.20.10.2', broker_port=1883, active: multiprocessing.Value = None, parent: ZigbeeNode = None, username=None, password=None, use_mock=False):
        self.active = active
        self.parent = parent
