...
class ZigbeeDriver():
    ...
    async def main(self):
        try:
            ...
            node = ZigbeeUINode(self.mac_id, active= shared_active, ip='10.191.95.222')  # 169.254.72.169; 127.0.0.1; 192.168.0.208; takes care of channel setup and looping (non-blocking)
