...
class ThisDevice(Device):
    ...
    def __init__(self, id, transceiver: ZigbeeTransceiver):  # inclusive bounds
        """
        ...
        self.transceiver: ZigbeeTransceiver = transceiver  # plugin object for sending and receiving messages
