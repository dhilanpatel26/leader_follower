import harness_device_classes as dc
...
class SimulationNode():
    ...
    def __init__(self, node_id):
        ...
        # self.process set later in set_process for test harness control
        self.process = None

    def set_process(self, new_target):
        self.process = multiprocessing.Process(target=new_target)
